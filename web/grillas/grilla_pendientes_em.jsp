...
<table id="table_pendientes" class="table table-striped table-bordered" style="width:100%">
    ...
    <tbody>
        ...
        while(rs.next()){ %>  
        <tr>
            <td><input  type="button" class="btn form-control bg-success color_letra" value="ASIGNAR OPERARIO" onclick="form_aprobar_em(<%=rs.getString("nro_pedido")%>,'<%=rs.getString("detalle")%>','<%=rs.getString("descripcion")%>');"></td> 
