...
<table id="table_generados" data-row-style="rowStyle" data-toggle="table" data-click-to-select="true"   id="tabla_recuento" class="table table-striped table-bordered ">
    <thead>
      <th >Nro</th>   
      <th >Descripcion</th>   
      <th >Detalle</th>   
