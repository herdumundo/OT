...
<%    
    ...
    String tipo_cancelacion =   request.getParameter("tipo_cancelacion");
    String txt_motivo       =   request.getParameter("txt_motivo");
    ...
    int tipo_respuesta=0;    try 
    {
        ...
        CallableStatement  callableStatement=null;   
                callableStatement=clases.controles.connectSesion.prepareCall("{call [mae_ot_cerrar_pedido](?,?,?,?,?,?)}");
                callableStatement.setInt(1,    Integer.parseInt(id_usuario) );
                callableStatement.setInt(2,    Integer.parseInt(id_pedido) );
                callableStatement.setInt(3,    Integer.parseInt(tipo_cancelacion) );
                callableStatement.setString(4, txt_motivo);
