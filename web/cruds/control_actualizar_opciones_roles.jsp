...
<%    
    ...
    int tipo_respuesta=0;    try 
    {
        ...
        CallableStatement  callableStatement=null;   
                callableStatement = clases.controles.connectSesion.prepareCall("{call  [mae_ot_add_del_opciones_roles] (?,?,?,?)}");
                callableStatement .setInt(1,  Integer.parseInt(id_rol) );
                callableStatement .setString(2,   opciones   );
