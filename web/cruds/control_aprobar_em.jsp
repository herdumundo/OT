...
<%    
    ...
    String id_operario  = request.getParameter("cbox_operario");
    ...
    try 
    {
        ...
        callableStatement = clases.controles.connectSesion.prepareCall("{call [mae_ot_aprobar_em](?,?,?,?,?,?)}");
        callableStatement .setInt(1,    Integer.parseInt(id_usuario) );
        callableStatement .setInt(2,    Integer.parseInt(id_pedido) );
        callableStatement .setString(3, id_operario );
