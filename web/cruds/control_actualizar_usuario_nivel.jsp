...
<%    
    ...
    int tipo_respuesta=0;    try 
    {
        ...
        CallableStatement  callableStatement=null;   
                callableStatement = clases.controles.connectSesion.prepareCall("{call [mae_ot_update_usuario_nivel_rol_estado](?,?,?,?,?)}");
                callableStatement .setInt(1,  Integer.parseInt(id_usuario) );
                callableStatement .setInt(2,  Integer.parseInt(id_nivel) );
                callableStatement .setInt(3,  Integer.parseInt(tipo) );
